...
// public AdoptionCaseApply(Integer adoptionCaseApplyId, String introduction,
...
// return "AdoptionCaseApply [adoptionCaseApplyId=" + adoptionCaseApplyId + ",
// introduction=" + introduction
// + ", applicationStatus=" + applicationStatus + ", adoptionCase=" +
// adoptionCase
// + ", getAdoptionCaseApplyId()=" + getAdoptionCaseApplyId() + ",
// getIntroduction()=" + getIntroduction()
// + ", isApplicationStatus()=" + isApplicationStatus() + ", getAdoptionCase()="
// + getAdoptionCase()
