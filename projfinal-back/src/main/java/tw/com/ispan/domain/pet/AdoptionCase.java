...
// // 雙向多對一,外鍵,對應city表
// @ManyToOne(cascade = { CascadeType.PERSIST, CascadeType.REMOVE })
// @JoinColumn(name = "distinctAreaId", nullable = false, foreignKey =
// @ForeignKey(name = "FK_AdoptionCase_DistinctArea"))
...
// @OneToMany
// @JoinColumn(name = "adoptionCase", foreignKey = @ForeignKey(name =
