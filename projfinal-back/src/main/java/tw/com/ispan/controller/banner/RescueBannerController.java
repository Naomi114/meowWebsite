...
public class RescueBannerController {
     ...
     */
    @PostMapping
    public ResponseEntity<?> createBanner(@RequestBody RescueBanner rescueBanner) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<?> updateBanner(@PathVariable Integer id, @RequestBody RescueBanner rescueBanner) {
