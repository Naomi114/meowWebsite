...
// */
// @PostMapping
// public ResponseEntity<?> createRescueBanner(@RequestBody RescueBanner
// rescueBanner) {
// if (rescueBanner.getRescueCase() == null ||
// rescueBanner.getRescueCase().getRescueCaseId() == null) {
...
// */
// @PutMapping("/{id}")
// public ResponseEntity<?> updateRescueBanner(@PathVariable Integer id,
// @RequestBody RescueBanner rescueBanner) {
// if (rescueBanner.getRescueCase() == null ||
// rescueBanner.getRescueCase().getRescueCaseId() == null) {
// return ResponseEntity.badRequest().body("RescueCase ID is required.");
// }

// Optional<RescueBanner> updatedBanner = rescueBannerService.update(id,
// rescueBanner);
