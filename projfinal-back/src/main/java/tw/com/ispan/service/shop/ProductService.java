...
// String productName = obj.isNull("productName") ? null :
// obj.getString("productName");
// String description = obj.isNull("description") ? null :
// obj.getString("description");
// BigDecimal originalPrice = obj.isNull("originalPrice") ? null :
// obj.getBigDecimal("originalPrice");
// BigDecimal salePrice = obj.isNull("salePrice") ? null :
// obj.getBigDecimal("salePrice");
// Integer stockQuantity = obj.isNull("stockQuantity") ? null :
...
// Integer categoryId = obj.isNull("categoryId") ? null :
...
// if (bean != null && bean.getProductId() != null &&
// !bean.getProductId().equals(0)) {
// Optional<ProductBean> optional =
// productRepository.findById(bean.getProductId());
// if (optional.isPresent()) {
