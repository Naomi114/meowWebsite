...
// !bean.getLostCaseId().equals(0)) {
// Optional<LostCase> optional =
// lostCaseRepository.findById(bean.getLostCaseId());
...
// // 驗證必填欄位
// if (caseTitle == null || memberId == null || speciesId == null || breedId ==
// null || furColorId == null ||
// sterilization == null || cityId == null || distinctId == null || street ==
// null || latitude == null
// ||
...
// // 提取欄位資料
// Integer lostCaseId = obj.isNull("lostCaseId") ? null :
// obj.getInt("lostCaseId");
...
// Integer furColorId = obj.isNull("furColorId") ? null :
// obj.getInt("furColorId");
...
// Integer microChipNumber = obj.isNull("microChipNumber") ? null :
// obj.getInt("microChipNumber");
// Boolean suspLost = obj.isNull("suspLost") ? null :
// obj.getBoolean("suspLost");
// Integer cityId = obj.isNull("cityId") ? null : obj.getInt("cityId");
// Integer distinctId = obj.isNull("distinctId") ? null :
// obj.getInt("distinctId");
// String street = obj.optString("street", null);
// BigDecimal latitude = obj.isNull("latitude") ? null :
// obj.getBigDecimal("latitude");
// BigDecimal longitude = obj.isNull("longitude") ? null :
// obj.getBigDecimal("longitude");
// Integer caseStateId = obj.isNull("caseStateId") ? null :
// obj.getInt("caseStateId");
// String lostExperience = obj.optString("lostExperience", null);
// String contactInformation = obj.optString("contactInformation", null);
// String featureDescription = obj.optString("featureDescription", null);
