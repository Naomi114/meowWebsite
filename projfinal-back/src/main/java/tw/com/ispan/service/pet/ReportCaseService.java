...
// } else {
// // 更新操作（ID 存在時）
// Optional<ReportCase> existing =
// reportCaseRepository.findById(reportCase.getReportId());
...
// } else {
// throw new IllegalArgumentException("要更新的 ReportCase 不存在，ID: " +
// reportCase.getReportId());
// }
// }
