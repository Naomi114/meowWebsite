...
public class LineBindingService {
    ...
    // 確認用戶有無追蹤Linebot帳戶
    public boolean checkFollow(Integer memberId) {
        return memberRepository.existsByMemberIdAndFollowed(memberId, true);
    }

    // 當用戶追蹤商家帳號後，將追蹤狀態改為true
    public void updateFollowed(String lineId) {
        memberRepository.updateFollowed(lineId);
    }
    ...
    // // member.setBindingTokenExpiry(LocalDateTime.now().plusMinutes(10)); //
    // Token 過期時間為10分鐘
    // //
    // // // 保存到數據庫
    ...
    // //
    // // // 返回綁定鏈接
    // // return "https://586f-1-160-6-252.ngrok-free.app/line/bind?token=" +
    // bindingToken; // 典型RESTful URL
    // // }

    // // 完成綁定// 查找對應的會員並驗證token
    // public ResponseEntity<String> completeBinding(String token, String
    // lineUserId) {
